  ...
  setup() {
    ...
    onMounted(() => {
      const script = function (p5) {
        ...
        p5.preload = () => {
          const x38imagePath = require('@/assets/img/x38plinko.png');
          const x12imagePath = require('@/assets/img/x12plinko.png');
          const x43imagePath = require('@/assets/img/x4.3plinko.png');
          const x2imagePath = require('@/assets/img/x2.0plinko.png');
          const x1imagePath = require('@/assets/img/x1.1plinko.png');
          const x05imagePath = require('@/assets/img/x0.5plinko.png');
          const x03imagePath = require('@/assets/img/x0.3plinko.png');
